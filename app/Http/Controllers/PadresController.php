...
class PadresController extends Controller
{
    ...
    public function store(Request $request)
    {
        $data =request()->validate([
            ...
            'escolaridadM'=>['required'], 'noHijosM'=>['required','max:15'], 
            
           
            
            'calle'=>['required', 'max:30'], 'numero'=>['required','max:2'],
        ...
        return redirect()->route('alumno.create')->with('Agregar', 'ok');
    ...
    public function storeTraslado(Request $request)
    {
        ...
        return redirect()->route('alumno.createTraaslado')->with('Agregar', 'ok');
